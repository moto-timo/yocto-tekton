...
- No QEMU in containers for <>-ptest-image (yet), and therefore
  the testimage-task.yaml steps have not been added to the yp-dev-day-virtualization
  pipeline

- Probably need to be refactored with one build step per:
  - xen-raspberry-pi4
  - intel-kvm-ubuntu
  - intel-acrn
